...
type TabType = 'WAREHOUSE' | 'STORE' | 'CATEGORY' | 'CASH_REGISTER';
...
export default function UserAttributionsPage() {
  ...
  const loadData = async () => {
    try {
      setLoading(true);
      const [userData, warehousesData, attributionsData] = await Promise.all([
      ...
      setSelectedWarehouseIds(
        attributionsData.map((a) => a.resourceId),
      );
    } catch (error) {
  ...
  const tabs = [
    ...
    { id: 'STORE' as TabType, label: t.stores },
    { id: 'CATEGORY' as TabType, label: t.categories },
