...
export interface ProviderCreditFormRef {
    submit: () => void;
}

interface ProviderCreditFormProps {
    providerId: string;
    credit?: any;
    onClose: () => void;
    onSuccess: () => void;
...
const ProviderCreditForm = forwardRef<ProviderCreditFormRef, ProviderCreditFormProps>(
    ({ providerId, credit, onSuccess, onSavingChange }, ref) => {
        const t = useTranslations('pages.providers.credit');
...
ProviderCreditForm.displayName = "ProviderCreditForm";

export default ProviderCreditForm;
