...
const menuItems: MenuItem[] = [
    ...
    subItems: [
      {
        ...
        path: '/dashboard/productos/agregar-producto',
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {
        name: 'Monedas',
        path: '/dashboard/productos/monedas',
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    subItems: [
      ...
      },
      {
        ...
        path: '/dashboard/almacenes/lista-de-almacenes',
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 10h16M4 14h16M4 18h16" />
          </svg>
  ...
  },
  {
    ...
    subItems: [
      ...
      {
        name: 'Añadir Venta',
        path: '/dashboard/ventas/agregar-venta',
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
          </svg>
  ...
  },
  {
    ...
    subItems: [
      {
        name: 'Crear Compra',
        path: '/dashboard/compras/crear-compra',
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
          </svg>
      ...
      },
      {
        ...
        path: '/dashboard/compras/lista-de-compras',
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 10h16M4 14h16M4 18h16" />
          </svg>
  ...
  },
  {
    ...
    subItems: [
      ...
      },
      {
        ...
        path: '/dashboard/configuracion/correo',
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      },
      {
        ...
        path: '/dashboard/configuracion/pasarela-pago',
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {
        name: 'Respaldo',
        path: '/dashboard/configuracion/respaldo',
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
