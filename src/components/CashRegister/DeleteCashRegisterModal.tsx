...
export default function DeleteCashRegisterModal({ cashRegister, onClose, onConfirm }: DeleteCashRegisterModalProps) {
          ...
          <div className="sm:flex sm:items-start">
            ...
            <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
              <h3 className="text-base font-semibold leading-6 text-gray-900">
                {t('deleteCashRegister')}
              </h3>
              <div className="mt-2">
                <p className="text-sm text-gray-500">
                  {t('messages.confirmDelete', { name: cashRegister.name })}
                </p>
              </div>
            </div>
          </div>
