...
export default function MeasurementUnitTable({ units, onEdit, onDelete, visibleColumns }: MeasurementUnitTableProps) {
            ...
            <tr key={unit.id} className="hover:bg-primary-50 transition-colors">
              ...
              {isVisible('status') && (
                <td className="px-6 py-4 whitespace-nowrap">
                  <span
                    className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${unit.status ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                      }`}
                  >
