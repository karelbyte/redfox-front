...
export const posHelp: HelpConfig = {
  title: { es: 'Guía del Punto de Venta (POS)', en: 'Point of Sale (POS) Guide' },
  description: {
  ...
  sections: [
    {
      icon: '🛒',
      title: { es: 'Agregar productos al carrito', en: 'Add products to cart' },
      content: {
    ...
    {
      icon: '✏️',
      title: { es: 'Editar cantidad y precio', en: 'Edit quantity and price' },
      content: {
    ...
    {
      icon: '👤',
      title: { es: 'Seleccionar cliente', en: 'Select client' },
      content: {
    ...
    {
      icon: '🖨️',
      title: { es: 'Ticket de venta', en: 'Sale ticket' },
      content: {
    ...
    {
      icon: '💰',
      title: { es: 'Caja registradora', en: 'Cash register' },
      content: {
    ...
    {
      icon: '🔄',
      title: { es: 'Carrito persistente', en: 'Persistent cart' },
      content: {
